...
def get_classifier_model(model_name):
    if model_name == "setfit_gyafc":
        classifier_model_path = "./model_checkpoints/setfit/gyafc_finetuned"
        classifier_model = SetFitModel.from_pretrained(classifier_model_path)
    elif model_name == "setfit_gyafc_5":
        classifier_model_path = "./model_checkpoints/setfit/gyafc_finetuned_5"
        classifier_model = SetFitModel.from_pretrained(classifier_model_path)
    elif model_name == "setfit_gyafc_10":
        classifier_model_path = "./model_checkpoints/setfit/gyafc_finetuned_10"
        classifier_model = SetFitModel.from_pretrained(classifier_model_path)
    elif model_name == "setfit_gyafc_40":
        classifier_model_path = "./model_checkpoints/setfit/gyafc_finetuned_40"
        classifier_model = SetFitModel.from_pretrained(classifier_model_path)
    elif model_name == "setfit_gyafc_5_v2":
        classifier_model_path = "./model_checkpoints/setfit/gyafc_finetuned_5_v2"
        classifier_model = SetFitModel.from_pretrained(classifier_model_path)
    elif model_name == "setfit_gyafc_10_v2":
        classifier_model_path = "./model_checkpoints/setfit/gyafc_finetuned_10_v2"
        classifier_model = SetFitModel.from_pretrained(classifier_model_path)
    elif model_name == "setfit_gyafc_20_v2":
        classifier_model_path = "./model_checkpoints/setfit/gyafc_finetuned_20_v2"
        classifier_model = SetFitModel.from_pretrained(classifier_model_path)
    elif model_name == "setfit_gyafc_40_withpartial":
        classifier_model_path = "./model_checkpoints/setfit/gyafc_finetuned_withpartial_40"
        classifier_model = SetFitModel.from_pretrained(classifier_model_path)
    elif model_name == "setfit_gyafc_partial_40":
        classifier_model_path = "./model_checkpoints/setfit/gyafc_finetuned_partial_40"
        classifier_model = SetFitModel.from_pretrained(classifier_model_path)
    elif model_name == "setfit_gyafc_partial_20":
        classifier_model_path = "./model_checkpoints/setfit/gyafc_finetuned_partial_20"
        classifier_model = SetFitModel.from_pretrained(classifier_model_path)
    elif model_name == "setfit_gyafc_partial_10":
        classifier_model_path = "./model_checkpoints/setfit/gyafc_finetuned_partial_10"
        classifier_model = SetFitModel.from_pretrained(classifier_model_path)
    elif model_name == "setfit_gyafc_partial_5":
        classifier_model_path = "./model_checkpoints/setfit/gyafc_finetuned_partial_5"
        classifier_model = SetFitModel.from_pretrained(classifier_model_path)
...
def parse_arguments():
    ...
    parser.add_argument('--generation_model_name', type=str, default="humarin", help="Name of the generation model (default: 'humarin')")
    parser.add_argument('--classifier_model_name', type=str, default="setfit_gyafc", help="Name of the classifier model (default: 'setfit_gyafc')")
    parser.add_argument('--dataset_name', type=str, default="paws-x", help="Name of the dataset (default: 'paws-x')")
    parser.add_argument('--samples', type=int, default=500, help="Number of samples for generation (default: 500)")
    parser.add_argument('--batch_size', type=int, default=32, help="Batch size for generation (default: 32)")
    parser.add_argument('--results_dir', type=str, default="generation_results", help="Directory to save generation results (default: 'generation_results')")
